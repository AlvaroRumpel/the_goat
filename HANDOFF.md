...
**Data:** 2026-07-29 · **Estado:** v1 + draft fenomeno + carreira viva + rebalance/humanização + calibração de médias + liga viva + motor de momentos completos e testados (156/156 testes verdes), pendente deploy — dono decide quando.
